...
Route::controller(AuthController::class)->group(function () {
    ...
    Route::get('forgot-password-page','forgotPage')->name('forgot.page');
    Route::post('forgot/password','forgot')->name('forgot');
    Route::get('reset-password/{nip}','resetPage')->name('reset.page');
    Route::post('reset-password/{nip}','reset')->name('reset');
});
...
Route::middleware(['auth', 'role:muspin'])->group(function () {
    ...
    Route::controller(MuspinController::class)->group(function () {
        ...
        Route::get('/gratifikasi/laporan','gratifikasi')->name('gratifikasi.page');
        Route::get('/benturan/laporan','benturan')->name('benturan.page');
    });
    Route::controller(LaporanController::class)->group(function () {
        ...
        Route::delete('/hapus/{id}/laporan','destroy')->name('hapus.laporan');
    });
