...
<div class="bg-white rounded-lg shadow-md p-6 w-full max-w-md mx-auto mt-10">
    ...
    <form action="{{ route('register') }}" method="POST" class="space-y-4">
        ...
        <div>
            ...
            <input type="text" name="nip" id="nip" required class="bg-gray-50 border border-gray-300 text-sm rounded-lg
                       focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Masukkan NIP">
        </div>
        <div>
