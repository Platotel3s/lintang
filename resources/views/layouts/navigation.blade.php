<nav class="flex flex-col bg-slate-900 text-white w-64 min-h-screen p-6 shadow-lg overflow-y-scroll">
    ...
    <div class="space-y-2 flex-1">
        ...
        <a href="{{ route('gratifikasi.page') }}"
            class="block px-4 py-2 rounded-lg hover:bg-slate-700 transition flex items-center justify-between {{ request()->routeIs('gratifikasi.page') ? 'bg-slate-800' : '' }}">
            <span><i class="fa-solid fa-book mr-2"></i> Gratifikasi</span>
        </a>
        <a href="{{ route('benturan.page') }}"
            class="block px-4 py-2 rounded-lg hover:bg-slate-700 transition flex items-center justify-between {{ request()->routeIs('benturan.page') ? 'bg-slate-800' : '' }}">
            <span><i class="fa-solid fa-book mr-2"></i> Benturan Kepentingan</span>
        </a>
        ...
        <a href="{{ route('index.periode')}}"
            ...
            <span><i class="fa-solid fa-calendar mr-2"></i>Daftar Laporan</span>
        </a>
