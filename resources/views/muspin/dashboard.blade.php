        ...
        <div class="bg-white rounded-xl shadow p-6">
            ...
            <table class="min-w-full text-left border border-gray-300 rounded-lg overflow-hidden">
                ...
                <tbody class="text-gray-600">
                    @foreach (\App\Models\Laporan::with(['upt','jenisLaporan'])->latest()->take(33)->get() as $laporan)
                    <tr class="border-t hover:bg-gray-50">
                        ...
                        <td class="py-3 px-4 text-center">
                            <a href="{{ route('laporan.show', $laporan->id) }}" class="text-blue-600 hover:underline">
