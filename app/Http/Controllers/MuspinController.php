...
class MuspinController extends Controller
{
    ...
    public function gratifikasi(Request $request){
        $gratifikasi=Laporan::where('jenis_laporan_id','1')->get();
        return view('muspin.jenisLaporan.gratifikasi',compact('gratifikasi'));
    }
    public function benturan(Request $request){
        $benturan=Laporan::where('jenis_laporan_id','2')->get();
        return view('muspin.jenisLaporan.benturan',compact('benturan'));
    }
}
